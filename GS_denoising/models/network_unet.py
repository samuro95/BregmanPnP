...
class ResUNet(nn.Module):
    def __init__(
        ...
        self.m_down1 = B.sequential(
            *[
                B.IMDBlock(nc[0], nc[0], bias=False, mode="C" + act_mode)
                for _ in range(nb)
            ],
            downsample_block(nc[0], nc[1], bias=False, mode="2")
        )
        self.m_down2 = B.sequential(
            *[
                B.IMDBlock(nc[1], nc[1], bias=False, mode="C" + act_mode)
                for _ in range(nb)
            ],
            downsample_block(nc[1], nc[2], bias=False, mode="2")
        )
        self.m_down3 = B.sequential(
            *[
                B.IMDBlock(nc[2], nc[2], bias=False, mode="C" + act_mode)
                for _ in range(nb)
            ],
            downsample_block(nc[2], nc[3], bias=False, mode="2")
        )
        ...
        self.m_body = B.sequential(
            *[
                B.IMDBlock(nc[3], nc[3], bias=False, mode="C" + act_mode)
                for _ in range(nb)
            ]
        )
...
class UNetResSubP(nn.Module):
    def __init__(
        ...
        self.m_body = B.sequential(
            *[
                B.ResBlock(nc[3], nc[3], mode="C" + act_mode + "C")
                for _ in range(nb + 1)
            ]
        )
